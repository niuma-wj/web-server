...
INSERT INTO `capital` VALUES ('1T2hb8aj0e',597000,120,970,NULL,NULL,NULL,NULL,NULL,17),('52A6Ov794x',1000000,0,1000,NULL,NULL,NULL,NULL,NULL,1),('6EtExZE9S4',1000000,0,1000,NULL,NULL,NULL,NULL,NULL,1),('bStUmPhnV4',192000,1000,148,NULL,NULL,NULL,NULL,NULL,67),('GHCsk3q0uW',72893500,9110,64,'$2a$10$YJqk72cUnvVyFFtrazil8eWt9XIGAgFxZiLG3QwL8lopP3Z2aCdoO','blackbutterfly66@hotmail.com','wujian','12345678','fuck',149),('MY8p0z7q00',40831,11,48,NULL,NULL,NULL,NULL,NULL,105),('X1ph176VVB',296450,2000,248,NULL,NULL,NULL,NULL,NULL,38);
...
INSERT INTO `district` VALUES (1,'逮狗腿新手房',1500,2),(2,'逮狗腿初级房',3000,2),(3,'逮狗腿高级房',7500,0),(4,'逮狗腿大师房',15000,0),(5,'掼蛋初级房',0,0),(6,'掼蛋中级房',0,0),(7,'掼蛋高级房',0,0),(8,'掼蛋大师房',0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='游戏故障记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `game_fault` VALUES (1,'PX7kp3tY32','game_server_001',0,'2025-02-12 15:21:57.045'),(2,'5hO5P3Bxm1','game_server_001',0,'2025-07-17 16:47:55.854');
...
CREATE TABLE `game_guan_dan` (
  ...
  UNIQUE KEY `venue_id_UNIQUE` (`venue_id`),
  KEY `number_index` (`number`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='掼蛋游戏表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `game_guan_dan` VALUES (3,'5Fz6Y6NY7L','049354',1),(5,'jmJ5NcNgj1','100701',1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='游戏计分牌，记录玩家在各种游戏的输赢及平局次数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `player` VALUES ('0000000000','system','123','系统账户','13000000001',1,'https://img1.baidu.com/it/u=135208876,3661679439&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=500',NULL,'',NULL,NULL,0,0,'1','2024-11-18 11:50:10','1','2024-11-18 11:50:10'),('1T2hb8aj0e','test04','$2a$10$wnt2yChtpt1Dp.VsUN..GuQxQhmHkXnm4kO3oZlM2cc/4FmZx2Dby','哈哈哈','13000000001',2,'https://img0.baidu.com/it/u=2734228536,2142226880&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',NULL,'192.168.6.220','2025-06-02 15:32:53',1748850594,0,0,'1','2025-02-07 09:12:41','1','2025-02-07 09:12:41'),('52A6Ov794x','wujian123','$2a$10$A03tn4Lax5aJ9C35DsIDbeunBkHG8ejZdOu05zbh5L75jn8ECemNq','大帅哥',NULL,1,'https://img1.baidu.com/it/u=719838411,1769667498&fm=253&fmt=auto&app=138&f=JPEG?w=200&h=200',NULL,'192.168.6.220','2025-02-21 17:26:01',NULL,0,0,'','2025-02-21 17:25:11','',NULL),('6EtExZE9S4','wujian321','$2a$10$hBgEUC/u9vT2n/OP8r0D0.Zr3cI/Wv9roVeH86ElPsBrF.xiG/zR6','超级帅',NULL,2,'https://img2.baidu.com/it/u=1824345149,1911120526&fm=253&fmt=auto?w=560&h=560',NULL,'192.168.6.220','2025-02-21 17:55:01',NULL,0,0,'','2025-02-21 17:54:38','','2025-02-21 17:54:38'),('bStUmPhnV4','test02','$2a$10$wnt2yChtpt1Dp.VsUN..GuQxQhmHkXnm4kO3oZlM2cc/4FmZx2Dby','很赚钱','13000000001',2,'https://img0.baidu.com/it/u=3430786044,814387293&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=800',NULL,'192.168.6.220','2025-06-02 15:49:08',1748850578,0,0,'1','2024-11-14 09:55:39','1','2024-11-16 18:05:50'),('GHCsk3q0uW','test','$2a$10$wnt2yChtpt1Dp.VsUN..GuQxQhmHkXnm4kO3oZlM2cc/4FmZx2Dby','测试','13000000001',1,'https://img0.baidu.com/it/u=1008951549,1654888911&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=800','0000000000','192.168.6.220','2025-06-02 15:29:13',1748850614,0,0,'1','2024-09-04 17:54:46','1','2024-09-04 17:54:46'),('MY8p0z7q00','test01','$2a$10$wnt2yChtpt1Dp.VsUN..GuQxQhmHkXnm4kO3oZlM2cc/4FmZx2Dby','测试01','13000000001',1,'https://img2.baidu.com/it/u=4113075832,3609938507&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=800','GHCsk3q0uW','192.168.6.220','2025-07-17 16:47:46',1752742528,0,0,'1','2024-11-14 09:55:39','1','2024-11-16 18:05:50'),('X1ph176VVB','test03','$2a$10$wnt2yChtpt1Dp.VsUN..GuQxQhmHkXnm4kO3oZlM2cc/4FmZx2Dby','叙利亚','13000000001',2,'https://img2.baidu.com/it/u=3793196658,2571329912&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=800',NULL,'192.168.6.220','2025-06-02 15:45:03',1748850603,0,0,'1','2024-11-14 09:55:39','1','2024-11-16 18:05:50');
...
CREATE TABLE `player_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='玩家登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'admin','若依','00','ry@163.com','15888888888','1','','$2a$10$PpeuNOjjZhm.qtRT2DH7E.jzcBlEzhHXubHR.zXbAPtTjz58D65mG','0','0','127.0.0.1','2025-03-05 08:46:37','admin','2024-08-30 17:22:39','','2025-03-05 08:46:36','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-08-30 17:22:39','admin','2024-08-30 17:22:39','',NULL,'测试员');
...
INSERT INTO `venue` VALUES ('1nr5I779iH','GHCsk3q0uW',NULL,1,0,'2024-10-31 17:40:25'),('22Bi84rTsq','GHCsk3q0uW',NULL,1027,2,'2024-12-30 09:37:27'),('47KJ5qdIMc','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:34:17'),('4H96j7K72Q','GHCsk3q0uW',NULL,1023,0,'2025-02-19 11:34:39'),('4Rwt693Dw6','0000000000',1,1028,0,'2025-02-12 15:32:16'),('5Fz6Y6NY7L','MY8p0z7q00',NULL,1030,0,'2025-07-17 16:22:57'),('5kOUhZSP7Q','0000000000',1,1028,0,'2025-02-13 10:19:13'),('8wsi0F9HOL','GHCsk3q0uW',NULL,1021,2,'2024-12-16 11:26:46'),('9hIa350FsU','GHCsk3q0uW',NULL,1,0,'2024-10-30 16:09:46'),('9P653iJ6qr','0000000000',1,1028,0,'2025-02-13 10:20:02'),('bQQ0wNyF4p','0000000000',3,1028,0,'2025-02-12 16:02:57'),('C0gFoS5Q6m','GHCsk3q0uW',NULL,1,0,'2024-10-30 11:53:54'),('d9ZJS6e4oH','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:45:05'),('DcDKWsURh8','GHCsk3q0uW',NULL,1027,0,'2024-12-30 11:18:00'),('I581n4rOG4','GHCsk3q0uW',NULL,1021,2,'2024-12-16 11:19:54'),('i6e69tDx4x','GHCsk3q0uW',NULL,1028,2,'2025-02-07 09:37:49'),('jmJ5NcNgj1','MY8p0z7q00',NULL,1030,0,'2025-07-17 16:51:02'),('oF804b1yYm','GHCsk3q0uW',NULL,1021,2,'2024-12-11 11:09:52'),('PX7kp3tY32','GHCsk3q0uW',NULL,1028,0,'2025-02-07 09:32:16'),('Qr3K5u492V','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:46:25'),('qR8ltaH22t','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:26:57'),('V27H841KFh','GHCsk3q0uW',NULL,1027,2,'2025-02-28 10:23:57'),('W3puJ7Q32s','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:43:53'),('X1RpTph6vM','GHCsk3q0uW',NULL,1021,0,'2024-12-16 14:49:15'),('XoGmwf8z8u','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:31:25'),('xZ8UQUCeQ7','GHCsk3q0uW',NULL,1027,2,'2025-02-28 14:49:23'),('z8q8I7S8w4','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:38:24'),('Zjv75Y6aj5','GHCsk3q0uW',NULL,1,0,'2024-10-30 10:45:29');
...
-- Dump completed on 2025-07-21  8:23:15
